    ...
    return (
      <div>
        <div className={styles.containerLessThan5}>
          <img className={styles.firstImageLessThan5} src={dataArr[0].imageUrl} onClick={() => {handleClickedImage(0, () => {toggleModal()})}} alt="host home" />
        </div>
      </div>
    );
  }
    ...
    <div>
      <div className={styles.mainContainer}>
        <div className={styles.firstImageContainer}>
          <img className={styles.firstImage} src={dataArr[0].imageUrl} onClick={() => {handleClickedImage(0, () => {toggleModal()})}} alt="host home" />
        </div>
        <div className={styles.secondImageContainer}>
          <img className={styles.secondImage} src={dataArr[1].imageUrl} onClick={() => {handleClickedImage(1, () => {toggleModal()})}} alt="host home" />
        </div>
        <div className={styles.thirdImageContainer}>
          <img className={styles.thirdImage} src={dataArr[2].imageUrl} onClick={() => {handleClickedImage(2, () => {toggleModal()})}} alt="host home" />
        </div>
        <div className={styles.fourthImageContainer}>
          <img className={styles.fourthImage} src={dataArr[3].imageUrl} onClick={() => {handleClickedImage(3, () => {toggleModal()})}} alt="host home" />
        </div>
        <div className={styles.fifthImageContainer}>
          <img className={styles.fifthImage} src={dataArr[4].imageUrl} onClick={() => {handleClickedImage(4, () => {toggleModal()})}} alt="host home" />
        </div>
      </div>
    </div>
  );
